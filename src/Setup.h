...
ProcSetup ()
{
  ...
  x = ICONSIZE / 2;
  p = ICONSIZE / 2;
  if ((setup > 0) && (xc > X0Taken) && (xc < (X0Taken + TaWidth))
      ...
      if (xc1 < TaWidth / 3)
      ...
      else
        {
          ...
          if ((xc > X0Taken + TaWidth / 2.6 * ax)
              ...
              && (yc > Y0Taken - 10 * ay) && (yc < Y0Taken + 10 * ay))
            {
              // Change Pieces Set
              ChangePiecesSet ();
            }
  ...
  x = SQBUTTON / 2;
  if ((xc > X0Buttons) && (xc < (X0Buttons + ButtWidth)) && (yc > (Y0Buttons))
      && (yc < (Y0Buttons + ButtHeight)))
    {
...
EnterSetupProcedure ()
{
  ...
  aa = MessageBox (hWnd, " Doriti Modificarea Pozitiei pe Tabla de Sah ? ",
                   " SETARE POZITIE ", MB_YESNO);
...
ExecuteLoadPiecesClear ()
{
  ...
  aa = MessageBox (hWnd, " Setati Pozitie Pornind de la Tabla Fara Piese ? ",
                   " SETARE POZITIE ", MB_YESNO);
...
ExecuteLoadPiecesInitial ()
{
  ...
  aa = MessageBox (hWnd, " Setati Pozitie de la Pozitia Initiala ? ",
                   " SETARE POZITIE ", MB_YESNO);
...
RedrawSetupButtons ()
{
  ...
  MyTextOut (X0Buttons + 15 * ax, Y0Buttons + 40 * ay + 2,
             " A L T E   S E T A R I ", RGB (0, 0, 255));
  ...
  MyTextOut (X0Buttons + 15 * ax + 0.5 * SQSIZE, Y0Buttons + 100 * ay + 2,
             " Sunet ON/OFF ", RGB (0, 0, 0));
